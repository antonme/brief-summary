#!/usr/bin/env python3
"""Create all icon_a sizes from the processed full-size version."""
...
def main():
    ...
    input_path = "assets/new_icon_a_full_test.png"
    ...
    print("Creating icon_a sizes:")
    for size in sizes:
        print(f"  {size}x{size}...", end=" ")
        resized = resize_to_square(img, size)

        output_path = f"assets/new_icon_a_{size}.png"
    ...
    print("\n✓ All icon_a sizes created successfully!")
