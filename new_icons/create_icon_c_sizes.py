#!/usr/bin/env python3
"""Create all icon_c sizes from the processed full-size version."""
...
def main():
    ...
    input_path = "assets/new_icon_c_full_test.png"
    ...
    print("Creating icon_c sizes:")
    for size in sizes:
        print(f"  {size}x{size}...", end=" ")
        resized = resize_to_square(img, size)

        output_path = f"assets/new_icon_c_{size}.png"
    ...
    print("\n✓ All icon_c sizes created successfully!")
